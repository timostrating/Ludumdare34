...
public class Tiling : MonoBehaviour {
    ...
    [SerializeField] private int offsetX = 2;         // the offset so that we don't get any weird errors

    // these are used for checking if we need to instantiate stuff
    [SerializeField] private bool hasARightBuddy = false;
	[SerializeField] private bool hasALeftBuddy = false;

    [SerializeField] private bool reverseScale = false;	
